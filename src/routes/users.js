...
module.exports = (db) => {
  router.get("/users", (req, res) => {
    db.query(
      `
      SELECT users.id, users.first_name, users.last_name, avatar, location, is_helper, is_helped, users.username, SUM(helpers.helper_rating) as helperRating, SUM(helped.helped_rating) as studentrating, users.active
      FROM users 
